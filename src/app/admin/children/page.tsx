...
export default function ChildrenList() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="container py-6 md:py-8 px-4 md:px-6 mx-auto">
                                    ...
                                    <div className="flex flex-col items-center justify-center p-4 md:p-6 space-y-6">
                                      <div className="flex gap-4 items-center">
                                        <div className="relative">
                                          {child.photoUrl ? (
                                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl border-4 border-primary overflow-hidden relative shadow-lg"><Image src={child.photoUrl} alt={child.childName} fill className="object-cover" /></div>
                                          ) : (
                                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl border-4 border-dashed border-slate-300 bg-slate-50 flex items-center justify-center"><UserCircle className="w-12 h-12 text-slate-300" /></div>
                                          )}
                                        ...
                                        <div className="bg-white p-2 border-2 md:border-4 border-primary rounded-xl shadow-xl"><Image src={`https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${child.id}`} alt="QR" width={60} height={60} /></div>
                                      </div>
                                      <div className="text-center">
                                        <p className="font-black text-xl md:text-2xl text-slate-900">{child.childName}</p>
                                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{child.parentMobileNumber}</p>
                                      </div>
                                      <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full pt-4">
